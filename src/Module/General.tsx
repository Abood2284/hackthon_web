...
const TOP_SECTION = {
  TITLE: 'AceBite - Game Development Hackathon',
  Typed_effect: ['168 hours of creation', 'Win Cash prizes'],
  SHORT_DESCRIPTION:
    'Join us on 20th November 2021 with over 100+ students from across the campus for 168 hours of creation, innovation, & fun.',
  IMG_SRC: boy,
  DISCORD_LINK: '',
  JUDGES_FORM_LINK:
...
const SOCIALS = {
  ...
  email: 'mailto:abdulraheemsayyed22@gmail.com',
  mail: 'abdulraheemsayyed22@gmail.com'
};

const MIDDLE_SECTION = {
  TITLE: 'What is AceBite Hackthon?',
  LONG_DESCRIPTION:
